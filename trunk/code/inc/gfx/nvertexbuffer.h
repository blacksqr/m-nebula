...
public:
    ...
    nVertexBuffer()
        : ref_gs(this),
          ...
          stride4(0)
    {
        n_memset(uv_ptr,0,sizeof(uv_ptr));
    };
	...
	/// check ray intersection with VB, returns t parameter on the ray, t < 0 no intersection
	float GetRayIntersection(nIndexBuffer* ib, const line3& ray);
