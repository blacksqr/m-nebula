...
private:
    ...
    void UpdateCartesians(quadcornerdata& cd) {
        ...
        x0>>=8; x1>>=8; x2>>=8;
        z0>>=8; z1>>=8; z2>>=8;
        this->vertex[0].u = (ushort)x1; this->vertex[0].v = (ushort)z1;
        this->vertex[1].u = (ushort)x2; this->vertex[1].v = (ushort)z1;
        this->vertex[2].u = (ushort)x1; this->vertex[2].v = (ushort)z0;
        this->vertex[3].u = (ushort)x0; this->vertex[3].v = (ushort)z1;
        this->vertex[4].u = (ushort)x1; this->vertex[4].v = (ushort)z2;
    }; 
