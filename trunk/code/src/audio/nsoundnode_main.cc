...
{
    n_assert(name);
    this->filePath.Set(this->refFile.get(), name);
...
{
    return this->triggerChannelName.c_str();
}
...
{
    return this->velChannelName.c_str();
}
...
nSoundNode::AttachChannels(nChannelSet* chnSet)
{
    ...
    this->velChannelIndex = chnSet->AddChannel(chnServer, this->velChannelName.c_str());
    this->triggerChannelIndex = chnSet->AddChannel(chnServer, this->triggerChannelName.c_str());
