...
proc map_input { } {
    set cwd [psel]
		...
		.map keyb0:v.down			"script:/observer.togglevis"
...
proc init_collision { } {
    new nopcodeserver /sys/servers/opcode
    new node_physics /sys/servers/physics
	set cwd [psel]
    sel /sys/servers/physics

    .begincollclasses
    .addcollclass default
    .addcollclass bird
    .endcollclasses
    
    .begincolltypes
    .addcolltype "default" "default" "quick"
	.addcolltype "default" "bird"  "exact"
    .addcolltype "bird" "bird" "exact"
    .endcolltypes
...
#	new nmeshutils			/sys/share/mutils
