...
public:
    ...
    virtual void Begin(nGfxServer* gfx, nShadowServer* shadow, bool readonly);
    /// load a mesh file
    virtual bool Load(const char* fileName);
    /// obtain pointer to vertex buffer object, incrs refcount!
    virtual nVertexBuffer* ObtainVertexBuffer();
    /// obtain pointer to index buffer object, incrs refcount!
    virtual nIndexBuffer* ObtainIndexBuffer();
    /// obtain pointer to shadow caster object, incrs refcount!
    virtual nShadowCaster* ObtainShadowCaster();
