...
/**
    ...
    @brief Nebula gfx server on top of Direct3D8.
...
protected:
	...
	// + 01-Dec-2002 compressed textures support, by Ilya Kliot, Clockwise  Ltd
	bool IsTextureFormatSupported(D3DFORMAT TextureFormat, D3DFORMAT AdapterFormat, D3DRESOURCETYPE type = D3DRTYPE_TEXTURE);
	void QueryFormats();
...
public:
	...
	bool			anisotropic_min_filter;
	bool			anisotropic_mag_filter;
