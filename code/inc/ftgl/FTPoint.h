...
class FTGL_EXPORT FTPoint
{
    public:
         ...
         */
        FTPoint operator * ( FTGL_DOUBLE multiplier)
        {
            FTPoint temp;
		...
		FTGL_FLOAT fx() const { return (FTGL_FLOAT)values[0];};
		FTGL_FLOAT fy() const { return (FTGL_FLOAT)values[1];};
		FTGL_FLOAT fz() const { return (FTGL_FLOAT)values[2];};
