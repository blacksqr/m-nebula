...
class FTGL_EXPORT FTFont
{
    public:
		...
		/**
		* Get state of the usage of Display Lists inside FTGL
		*
		* @return state of usage diplay lists
		*/
		bool IsDisplayListInUse( void ) const { return this->useDisplayLists; }		
        
        /**
		* Enable or disable the usage of default rendering attributes suitable 
		* for specific font
		*
		* @param  useList <code>true</code> turns ON usage of default attributes.
		*                 <code>false</code> turns OFF usage of default attributes.
		*/
		void UseDefaultAttribs( bool val) { this->useDefaultAttribs = val; }

		/**
		* Get state of the usage of default rendering attributes suitable 
		* for specific font
		*
		* @return  state of the usage of default rendering attributes		
		*/
		bool IsDefaultAttribsInUse( void ) const { return this->useDefaultAttribs; }
    ...
    protected:
		...
		/**
		* Flag to enable or disable the use of default OpenGL options 
		* for rendering of specific font
		* <code>true</code> turns ON usage of default attributes.
		* <code>false</code> turns OFF usage of default attributes.
		*/
		bool useDefaultAttribs;
        /**
