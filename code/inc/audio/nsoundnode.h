...
private:
    ...
    stl_string velChannelName;     // velocity channel name
    stl_string triggerChannelName; // playback trigger channel name
...
{
    return this->soundCue.empty() ? 0 : this->soundCue.c_str();
}
