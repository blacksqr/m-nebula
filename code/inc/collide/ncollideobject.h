...
public:
    ...
    */
    void VisualizeLocal(nGfxServer *gs, nPrimitiveServer *prim) {
        n_assert(gs);
        n_assert(prim);
        ...
        {
            prim->Rgba(this->visColor.x, this->visColor.y, this->visColor.z, this->visColor.w);
        }
        ...
        for (dim=0; dim<3; dim++) {
            ...
            for (r=0.0f; r<n_deg2rad(360.0f); r+=dr) {
                ...
                prim->Coord(v0_x.x,v0_x.y,v0_x.z); prim->Coord(v1_x.x,v1_x.y,v1_x.z);
                prim->Coord(v0_y.x,v0_y.y,v0_y.z); prim->Coord(v1_y.x,v1_y.y,v1_y.z);
                prim->Coord(v0_z.x,v0_z.y,v0_z.z); prim->Coord(v1_z.x,v1_z.y,v1_z.z);
            }
        }
        prim->End();
    ...
    */
    void VisualizeGlobal(nPrimitiveServer *prim) {
        n_assert(prim);
        ...
        if (this->num_colls > 0) {
            ...
            for (i=0; i<num; i++) {
                ...
                prim->Rgba(1.0f,1.0f,0.0f,1.0f);
                prim->Coord(cnt.x-0.5f,cnt.y,cnt.z); prim->Coord(cnt.x+0.5f,cnt.y,cnt.z);
                prim->Coord(cnt.x,cnt.y-0.5f,cnt.z); prim->Coord(cnt.x,cnt.y+0.5f,cnt.z);
                prim->Coord(cnt.x,cnt.y,cnt.z-0.5f); prim->Coord(cnt.x,cnt.y,cnt.z+0.5f);
                vector3& n = cr->co1_normal;
                prim->Rgba(1.0f,0.0f,0.0f,1.0f);
                prim->Coord(cnt.x,cnt.y,cnt.z); prim->Coord(cnt.x+n.x,cnt.y+n.y,cnt.z+n.z);
                n = cr->co2_normal;
                prim->Rgba(1.0f,0.0f,0.0f,1.0f);
                prim->Coord(cnt.x,cnt.y,cnt.z); prim->Coord(cnt.x+n.x,cnt.y+n.y,cnt.z+n.z);
            }
        ...
        prim->Coord(v0.x,v0.y,v0.z); prim->Coord(v1.x,v0.y,v0.z);
        prim->Coord(v1.x,v0.y,v0.z); prim->Coord(v1.x,v1.y,v0.z);
        prim->Coord(v1.x,v1.y,v0.z); prim->Coord(v0.x,v1.y,v0.z);
        prim->Coord(v0.x,v1.y,v0.z); prim->Coord(v0.x,v0.y,v0.z);
        prim->Coord(v0.x,v0.y,v1.z); prim->Coord(v1.x,v0.y,v1.z);
        prim->Coord(v1.x,v0.y,v1.z); prim->Coord(v1.x,v1.y,v1.z);
        prim->Coord(v1.x,v1.y,v1.z); prim->Coord(v0.x,v1.y,v1.z);
        prim->Coord(v0.x,v1.y,v1.z); prim->Coord(v0.x,v0.y,v1.z);
        prim->Coord(v0.x,v0.y,v0.z); prim->Coord(v0.x,v0.y,v1.z);
        prim->Coord(v1.x,v0.y,v0.z); prim->Coord(v1.x,v0.y,v1.z);
        prim->Coord(v1.x,v1.y,v0.z); prim->Coord(v1.x,v1.y,v1.z);
        prim->Coord(v0.x,v1.y,v0.z); prim->Coord(v0.x,v1.y,v1.z);
        prim->End();
    };
};
//-------------------------------------------------------------------
