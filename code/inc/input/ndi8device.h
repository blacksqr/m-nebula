...
/**
    ...
    @brief Hold information about a DirectInput8 device. There is one
    nDI8Device object per supported DirectInput device.
...
private:
    ...
    stl_string instanceName;
    stl_string productName;
