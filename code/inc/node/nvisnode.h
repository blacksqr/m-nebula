...
public:
    ...
    */
    ...
    void DependsOn(nVisNode* dependObject, bool ahead=false); // Changed by Zeev Clockwise
    ...
    */
	...
	/// set node to be rendered on screen (HUD)
	void SetHUD(bool b) { this->hud = b; }

	/// get HUD state
	bool GetHUD(void) const { return this->hud; }
