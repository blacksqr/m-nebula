...
nD3D8IndexBuffer::Lock()
{
	...
	// BUGFIX: A locked array should expose it's i_array to GetIndexPointer()
	//		   by pointing to the i_array
	this->alloc_array = this->i_array;
    return true;
}
...
nD3D8IndexBuffer::Unlock()
{
    ...
    this->i_array   = this->alloc_array = 0;
}
