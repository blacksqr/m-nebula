            ...
            case ButtonPress:
                if (this->ref_is.isvalid())
                {
                    ...
                    if (ie)
                    {
                        ...
                        float relX = float(this->event.xbutton.x) / this->disp_w;
                        float relY = float(this->event.xbutton.y) / this->disp_h;
            ...
            case MotionNotify:
                if (this->ref_is.isvalid())
                {
                    ...
                    if (ie)
                    {
                        ...
                        ie->SetDeviceId(N_INPUT_MOUSE(0));
                        ie->SetAbsPos(x, y);
                        float relX = float(this->event.xmotion.x) / this->disp_w;
                        float relY = float(this->event.xmotion.y) / this->disp_h;
                        ie->SetRelPos(relX, relY);
                        this->ref_is->LinkEvent(ie);
                    }
                }
