...
nCmdProto::nCmdProto(const char *_proto_def)
{
    ...
    while ((c = *str++)) {
        ...
        switch(c) {
            ...
            case 's':   cmd->In()->SetS(0);		break;
            case 'u':   cmd->In()->SetU(0);		break;
            case 'o':   cmd->In()->SetO(0);		break;
            case 'c':   cmd->In()->SetC(0);		break;
            case 'l':   cmd->In()->SetL(0,0);	break;
            default:    break;
       } 
    }
    ...
    while ((c = *str++)) {
        ...
        switch(c) {
            ...
            case 's':   cmd->Out()->SetS(0);	break;
            case 'u':   cmd->Out()->SetU(0);	break;
            case 'o':   cmd->Out()->SetO(0);	break;
            case 'c':   cmd->Out()->SetC(0);	break;
            case 'l':   cmd->Out()->SetL(0, 0);	break;
            default:    break;
       } 
    }
