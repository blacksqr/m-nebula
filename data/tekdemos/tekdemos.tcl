...
#           17-Feb-02   floh    removed d3d7 stuff
#
...
#    .f1.mb.m1 add radiobutton -label "Skin Deformation"        -variable demo -command { load_script boneanim.tcl    0.5 }
    ...
    .f1.mb.m1 add radiobutton -label "Hierarchical Animation2" -variable demo -command { load_script machine.tcl  0.4
                                                                                         /usr/lookat.txyz   0    0    0
                                                                                         /usr/lookat.rxyz  -5   25   0
                                                                                         /usr/camera.txyz    0 5 10
                                                                                       }
...
#    .f1.mb.m1 add radiobutton -label "Material Ed (old)"      -variable demo -command { load_script materialed.tcl  0   }
    ...
    .f1.mb.m1 add radiobutton -label "Bump Mapping"       -variable demo -command { load_script bump.tcl    0.5 }
