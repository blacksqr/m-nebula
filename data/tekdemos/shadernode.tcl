...
#--------------------------------------------------------------------
#   alphatest_shader()
#   just moved here from main menu
#--------------------------------------------------------------------
proc alphatest_shader {} {
    new nshadernode sn
        sel sn
...
.r.f1.mb1.m add command -label "AlphaTest"    -command { replace_shader alphatest_shader;    .r.f1.mb1 configure -text "AlphaTest" }

checkbutton .r.f1.cb1 -text "Rotation Off" -indicatoron 1 -variable freezetime    -command toggle_anim
